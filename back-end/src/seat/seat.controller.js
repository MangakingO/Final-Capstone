...
// Middleware to check if the request body has a valid reservation_id property.
...
// Middleware to check if a reservation with a given reservation_id exists.
...
// Middleware to validate if a table is suitable for the reservation.
...
// Handler to update a table's reservation assignment.
...
// Handler to unassign a table, finishing the associated reservation.
