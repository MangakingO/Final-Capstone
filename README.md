...
To set up your database for this project, follow these steps:

## 1. Create ElephantSQL Instances

Create four new instances in ElephantSQL with the following names:
- Production
- Development
- Test
- Preview

Ensure that you have the necessary access to create these instances.

## 2. Configure DBeaver Connections

1. Open DBeaver.
2. Click on "New Connection" in the top left corner.

For each instance you created in ElephantSQL (Production, Development, Test, and Preview), do the following:

3. Select "PostgreSQL" as the database type.

4. Copy and paste the following information from your ElephantSQL database to the corresponding connection in DBeaver:
   - Server
   - Username
   - Database
   - Password

Repeat this process for each instance, configuring separate connections for each one.

## 3. Migrate and Seed the Database

Now that your connections are set up, you can migrate and seed your database using Knex. Open your terminal and navigate to the backend folder of your project.

Use the following commands to set up your database and tables:
...
This process will configure your database and tables, making it ready for use with your project. You can now proceed to set up and run the frontend of your application.
